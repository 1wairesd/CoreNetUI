...
/**
 * Event bus for Discord Bot Manager events.
 * Extends Kyori EventBus for powerful event handling capabilities.
 */
public interface EventBus extends net.kyori.event.EventBus<DBMEvent> {
