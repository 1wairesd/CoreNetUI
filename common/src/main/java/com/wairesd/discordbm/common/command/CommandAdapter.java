package com.wairesd.discordbm.common.command;

import com.wairesd.discordbm.api.command.Command;
import com.wairesd.discordbm.api.command.CommandOption;
import com.wairesd.discordbm.common.models.command.CommandOptions;
...
public class CommandAdapter implements Command {
    ...
    private com.wairesd.discordbm.common.models.command.Command internalCommand;
    ...
    public CommandAdapter(com.wairesd.discordbm.common.models.command.Command internalCommand) {
    ...
    public com.wairesd.discordbm.common.models.command.Command getInternalCommand() {
        return internalCommand;
    }

    private com.wairesd.discordbm.common.models.command.Command convertToInternalCommand(Command apiCommand) {
        List<CommandOptions> options = apiCommand.getOptions().stream()
            .map(this::convertToInternalOption)
            .collect(Collectors.toList());
        
        return new com.wairesd.discordbm.common.models.command.Command.Builder()
    ...
    private Command convertToApiCommand(com.wairesd.discordbm.common.models.command.Command internalCommand) {
