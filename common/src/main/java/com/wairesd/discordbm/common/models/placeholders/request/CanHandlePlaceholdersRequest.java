...
public class CanHandlePlaceholdersRequest {
    private final String type;
    private final String player;
    private final List<String> placeholders;
    private final String requestId;

    private CanHandlePlaceholdersRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CanHandlePlaceholdersRequest build() {
            return new CanHandlePlaceholdersRequest(this);
        }
    }
}
