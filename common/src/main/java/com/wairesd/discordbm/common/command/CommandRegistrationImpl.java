...
public class CommandRegistrationImpl implements CommandRegistration {
    ...
    private void sendRegistrationMessage(Command command) {
        ...
        RegisterMessage<com.wairesd.discordbm.common.models.command.Command> msg = 
            new RegisterMessage.Builder<com.wairesd.discordbm.common.models.command.Command>()
                .type("register")
